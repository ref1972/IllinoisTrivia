    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <h1 className="text-3xl font-bold text-[#0B1C3A]">Venues</h1>
        </div>
      </div>
      ...
      <section className="mb-8">
        ...
        >
          ...
          <button type="submit" className="bg-[#C83803] text-white px-4 py-2 rounded text-sm font-medium hover:bg-orange-800 transition-colors whitespace-nowrap">
            Add Venue
          </button>
        </form>
      </section>
